...
stores.each do |c|
  puts "#{c.name} has an annual revenue of #{c.annual_revenue}"
end

@womens_stores = Store.where(womens_apparel: true)

@womens_stores_under_one_million = @womens_stores.where("annual_revenue > 1000000")


puts @womens_stores_under_one_million
